...
//            Tamagotchi will need to be fed.
//            To feed: type "feed snack" or "feed meal" to increase hp
...
//        }
        ...
        public void run() {
            ...
            if (getHealthPoints() == 4){
                healthMeter();
                System.out.println("Would you like to feed a snack? (type 'feed snack' or 'no')");
            }
        }
    }
